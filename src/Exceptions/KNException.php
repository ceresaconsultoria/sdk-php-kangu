 ...
 * @author weslley
 */
class KNException extends Exception{
    ...
    public static function fromObjectMessage($message, $code, $previous = null){
        ...
        if(is_object($message)){
            ...
            return new KNException( new Exception(implode("\n", $newMessageString), $code, $previous) );     
        }
        
        if(is_string($message)){
            
            return new KNException( new Exception($message, $code, $previous) );     
